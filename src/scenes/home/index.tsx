            ...
            <div className="z-10 mt-32 md:basis-3/5">
                ...
                >
                    ...
                    <p className="mt-8 text-sm">
                        Lorem impsun text that i have no time to generate. Thanks for you attention
                        Lorem impsun text that i have no time to generate. Thanks for you attention
                        Lorem impsun text that i have no time to generate. Thanks for you attention
                    </p>
                </motion.div>
                ...
                >
                    ...
                    <ScrollLink className="text-sm font-bold text-primary-500 underline hover:text-secondary-500"
